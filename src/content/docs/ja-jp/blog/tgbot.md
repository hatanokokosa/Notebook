...
tags:
  - Bot
  - AI
excerpt: 今まで使ってきた転送 Bot に広告がやたらと来るようになり、開発者もブロック機能を追加してくれない。気づいたらプロジェクトは 1 年も放置されていた。VPN の宣伝、アダルト誘導、U 盾などの迷惑メッセージが毎日届くのに耐えきれず、自分で書き直すことにした……
---
...
コードは GitHub にプッシュして、BSD2 ライセンスで公開した。
