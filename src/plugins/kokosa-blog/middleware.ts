...
import { autoCollapseLongSidebarGroups, humanizeAutogeneratedGroupLabels } from "./libs/sidebar";
import {
  getPathWithLocale,
  getRelativeBlogUrl,
  getRelativeUrl,
...
export const onRequest = defineRouteMiddleware(async (context) => {
  ...
  if (!isAnyBlogPage(id)) {
    ...
    humanizeAutogeneratedGroupLabels(starlightRoute.sidebar);
    autoCollapseLongSidebarGroups(starlightRoute.sidebar);
    return;
  }
